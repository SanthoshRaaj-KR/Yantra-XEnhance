...
const ImageDenoiser = () => {
  ...
  const handleDenoiseClick = async (e) => {
    ...
    try {
      ...
      const fullUrl = `http://localhost:8000${data.processed_url}`;
            ...
            <div className="space-y-4">
              <div>
                <p className="mb-2 text-gray-700">
                  ...
                  {noiseType && noiseType.charAt(0).toUpperCase() + noiseType.slice(1)} Noise
                </p>
